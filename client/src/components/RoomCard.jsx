...
const RoomCard = ({ room, isGuest, isLiked, onToggleLike, onGuestClick }) => {
    return (
        <Link 
            ...
            className="min-w-[85vw] md:min-w-[350px] lg:min-w-[400px] snap-center group bg-gray-800 rounded-3xl overflow-hidden border border-gray-700 hover:border-blue-500 transition-all block cursor-pointer"
        >
